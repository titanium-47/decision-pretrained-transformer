...
# Or:    python evals/eval_interactive_bandit.py --dim 5 --H 100 --n_eval 100 --model_path trained_models/interactive_bandit.pt
...
python evals/eval_interactive_bandit.py \
  ...
  --n_eval 100 \
  --var 0.3 \
  --model_path trained_models/interactive_bandit.pt \
